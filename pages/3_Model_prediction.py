...
form1.subheader('Sex')
sex = form1.selectbox('Select the sex', ['Male', 'Female'])
# sex = form1.number_input('Enter sex', help='Please enter 0 for male, 1 for female', min_value=0.0, max_value=1.0, step=1.0)
...
if predict_button:
    if float(bill_length) == 0.0:
        st.write('This is not a valid bill length')
    else:
